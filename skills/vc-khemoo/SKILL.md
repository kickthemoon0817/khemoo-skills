...
The slug is a 2–4 word summary of the change (e.g. `fix/empty-diff-handling`, `docs/vc-khemoo-bump-rules`). Run `git checkout -b <branch>`, announce the branch name, then continue with Stage 1.
