...
Repo-specific context for AI agents working in this repo — Claude Code, Codex, and other CLIs. Project conventions live in [CONTRIBUTING.md](./CONTRIBUTING.md); this file holds the highest-value tactical reminders.
